            ...
            <ul class="dropdown-menu">
                @forelse ($datarole as $item)
                    @if ($item == 'Koperasi - Laporan - Tagihan Penjualan Kredit')
                        <li><a class="nav-link" href="{{ route('koperasi.tagihan-kredit.index') }}">Tagihan
                                Penjualan Kredit</a>
                        </li>
                    @elseif ($item == 'Koperasi - Laporan - Simpan Pinjam')
                        <li><a class="nav-link" href="{{ route('koperasi.simpan-pinjam.index') }}">Simpan
                                Pinjam</a></li>
                    @endif
                @empty
                @endforelse
            ...
            <ul class="dropdown-menu">
                @forelse ($datarole as $item)
                    ...
                    @elseif ($item == 'POS - Master - Barang-Kategori')
                        <li><a class="nav-link" href="{{ route('pos.master.kategori.index') }}">Barang -
                                Kategori</a></li>
            ...
            <ul class="dropdown-menu">
                @forelse ($datarole as $item)
                    ...
                    @elseif ($item == 'POS - Transaksi - Retur Pembelian')
                        <li><a class="nav-link" href="{{ route('pos.returpembelian.index') }}">Retur
                                Pembelian</a></li>
            ...
            <ul class="dropdown-menu">
                @forelse ($datarole as $item)
                    @if ($item == 'POS - Laporan - Realtime Stok')
                        <li><a class="nav-link" href="{{ route('poslaporan.realtimestok.index') }}">Realtime
                                Stok</a></li>
                    @elseif ($item == 'POS - Laporan - Penjualan')
                        <li><a class="nav-link" href="{{ route('poslaporan.penjualan.index') }}">Penjualan</a>
                        </li>
                    @elseif ($item == 'POS - Laporan - Pembelian')
                        <li><a class="nav-link" href="{{ route('poslaporan.pembelian.index') }}">Pembelian</a>
                        </li>
                    @elseif ($item == 'POS - Laporan - Minimum Stok')
                        <li><a class="nav-link" href="{{ route('poslaporan.minimumstok.index') }}">Minimum
                                Stok</a></li>
                    @elseif ($item == 'POS - Laporan - Opname | Hilang/Rusak')
                        <li><a class="nav-link" href="{{ route('poslaporan.opnamehilang.index') }}">Opname |
                                Hilang/Rusak</a></li>
                    @elseif ($item == 'POS - Laporan - Pareto Penjualan')
                        <li><a class="nav-link" href="{{ route('poslaporan.paretopenjualan.index') }}">Pareto
                                Penjualan</a></li>
                    @elseif ($item == 'POS - Laporan - Trace Stok')
                        <li><a class="nav-link" href="{{ route('poslaporan.tracestok.index') }}">Trace Stok</a>
                        </li>
                    @elseif ($item == 'POS - Laporan - Cetak Label Harga')
                        <li><a class="nav-link" href="{{ route('poslaporan.trcetak.index') }}">Cetak Label
                                Harga</a></li>
                    @elseif ($item == 'POS - Laporan - Mutasi Bulanan')
                        <li><a class="nav-link" href="{{ route('poslaporan.mutasibulanan.index') }}">Mutasi
                                Bulanan</a></li>
                    @elseif ($item == 'POS - Laporan - Laba Rugi')
                        <li><a class="nav-link" href="{{ route('poslaporan.labarugi.index') }}">Laba Rugi</a>
                        </li>
                    @elseif ($item == 'POS - Laporan - Retur Pembelian')
                        <li><a class="nav-link" href="{{ route('poslaporan.retur_pembelian.index') }}">Retur
                                Pembelian</a></li>
                    @endif
                @empty
                @endforelse
