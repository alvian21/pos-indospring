...
@section('title', 'Laporan Opname | Rusak / Hilang')
...
<section class="section">
    <div class="section-header">
        <h1>Laporan Opname | Rusak / Hilang</h1>
    </div>
            ...
            <div class="col-6">
                <div class="card card-dark">
                    <div class="card-header container-fluid d-flex justify-content-between">
                        <h4 class="text-dark"><i class="fas fa-list pr-2"></i> Laporan Opname | Rusak / Hilang</h4>
                    </div>
                    <div class="card-body">
                        @include('frontend.include.alert')
                        <form method="POST" action="{{route('poslaporan.opnamehilang.cetak')}}" target="_blank">
                            @csrf
