...
<head>
    <meta charset="utf-8">
    <title>Laporan Realtime Stok</title>
    <style>
        .clearfix:after {
            content: "";
            display: table;
...
<body>
    <header class="clearfix">
        ...
        <h1 style="color: #34abeb">Laporan Realtime Stok</h1>
    </header>
    <main>
        <table>
            <thead>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td align="right">{{$item['P1']}}</td>
                    <td align="right">{{$item['P2']}}</td>
                    <td align="right">{{$item['P2'] + $item['P1']}}</td>
