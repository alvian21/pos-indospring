...
@section('title', 'Transaksi | Stock Hilang')
            ...
            <div class="col-12">
                <div class="card card-dark">
                    <div class="card-header container-fluid d-flex justify-content-between">
                        <h4 class="text-dark"><i class="fas fa-list pr-2"></i> Transaksi | stockhilang</h4>
                        <div class="row">
                            <div class="col-md-12">
    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12">
                <div class="card card-dark">
                    <div class="card-header container-fluid d-flex justify-content-between">
                        <h4 class="text-dark"><i class="fas fa-list pr-2"></i> Detail Transaksi | stockhilang</h4>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="transaksiModalLabel">Transaksi stockhilang</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="POST" action="{{route('pos.transaksi_stockhilang.store')}}">
                @csrf
        ...
        <div class="modal-content">
            ...
            <form  id="formDetail">
                ...
                <div class="modal-body">
                    ...
                    @else
                    <h3 class="text-center">Input Data Transaksi stockhilang terlebih dahulu</h3>
                    @endif
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
<script type="text/javascript">
    ...
    var table = $("#table-transaksi").DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: "{{ route('pos.stockhilang.transaksi') }}",
        columns: [
