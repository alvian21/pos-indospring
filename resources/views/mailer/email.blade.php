                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href="http://localhost"
                                ...
                                Koperasi Karyawan PT. Indospring
                            </a>
                        </td>
                    </tr>
                    <!-- Email Body -->
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            Silahkan klik tombol di bawah ini untuk melakukan registrasi :</p>
                                        <center> <a href="{{route('verifieduser',[$data['token']])}}" type="button"
                                                class="myButton" target="_blank">Registrasi</a></center>
                                        <p
                                            style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Regards,<br></p>
                                    </td>
                                ...
                                <tr>
                                    <td class="content-cell" align="center"
                                        ...
                                        <p
                                            ...
                                            © {{date('Y')}} Big D Team. All rights reserved.</p>
